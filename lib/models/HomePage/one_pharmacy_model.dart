class OnePharmacyModel {
  ...
  factory OnePharmacyModel.fromJson(Map<String, dynamic>? json) =>
      OnePharmacyModel(
        status: json?["status"],
        code: json?["code"],
        msg: json?["msg"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic>? json) => Data(
        ...
        activeMedicines: json?["active_medicines"] == null
            ? null
            : List<ActiveMedicine>.from(json?["active_medicines"]
                .map((x) => ActiveMedicine.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "active_medicines": activeMedicines == null
            ? null
            : List<dynamic>.from(activeMedicines!.map((x) => x.toJson())),
        "distance": distance,
